...
///
/// 2026-09-13 修正:
///   - 实测原 PRIMARY 10 台全部 K线/行情双空（TCP 可达但数据接口失效，
///     仅逐笔族命令可用），connect_to_any() 与重试切服因此整体失效
///   - 置顶 8 台实测全功能站点（安信 + 国泰君安 ×7，bars/quotes/分笔全通）
pub const PRIMARY_SERVERS: &[(&str, &str, u16)] = &[
    // ── 2026-09-13 实测全功能（安信/国泰君安）──
    ("安信",        "59.36.5.11", 7709),
